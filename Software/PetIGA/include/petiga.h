...
typedef PetscErrorCode (*IGAFormScalar2)(IGAPoint point,const PetscScalar U[],const PetscScalar V[],PetscInt n,PetscScalar S[],void *ctx);
...
typedef PetscErrorCode (*IGAFormSystemSemiStagger)(IGAPoint point,PetscScalar K[],PetscScalar F[],PetscScalar UStagger[],void *ctx);
typedef PetscErrorCode (*IGAFormSystemStagger)(IGAPoint point,IGAPoint point_stagger,PetscScalar K[],PetscScalar F[],PetscScalar UStagger[],void *ctx);
...
typedef PetscErrorCode (*IGAFormIFunction)(IGAPoint point,
                                           ...
                                           PetscScalar F[],void *ctx);
typedef PetscErrorCode (*IGAFormIFunctionStagger)(IGAPoint point,IGAPoint point_stagger,
                                           PetscReal a,const PetscScalar V[],
                                           PetscReal t,const PetscScalar U[],const PetscScalar UStagger[],
                                           PetscScalar F[],void *ctx);
typedef PetscErrorCode (*IGAFormIJacobian)(IGAPoint point,
                                           PetscReal a,const PetscScalar V[],
                                           PetscReal t,const PetscScalar U[],
                                           PetscScalar J[],void *ctx);
typedef PetscErrorCode (*IGAFormIJacobianStagger)(IGAPoint point,IGAPoint point_stagger,
                                           PetscReal a,const PetscScalar V[],
                                           PetscReal t,const PetscScalar U[],const PetscScalar UStagger[],
                                           PetscScalar J[],void *ctx);
...
struct _IGAFormOps {
  ...
  IGAFormSystemSemiStagger SystemSemiStagger;
  ...
  IGAFormIFunctionStagger  IFunctionStagger;

  void              *IFunCtx;
  IGAFormIJacobian  IJacobian;
  IGAFormI2Jacobian I2Jacobian;
  IGAFormIJacobianStagger  IJFunctionStagger;
  void              *IJacCtx;
  /**/
...
PETSC_EXTERN PetscErrorCode IGASetFormSystemSemiStagger     (IGA iga,IGAFormSystemSemiStagger      System,     void *ctx);
PETSC_EXTERN PetscErrorCode IGASetFormSystemStagger     (IGA iga,IGAFormSystemStagger      System,     void *ctx);
...
PETSC_EXTERN PetscErrorCode IGASetFormIFunctionStagger  (IGA iga,IGAFormIFunctionStagger   IFunction,  void *ctx);
PETSC_EXTERN PetscErrorCode IGASetFormIJacobianStagger  (IGA iga,IGAFormIJacobianStagger   IJacobian,  void *ctx);
...
PETSC_EXTERN PetscBool      IGANextElementStagger(IGA iga,IGA iga_stagger,IGAElement element,IGAElement element_stagger);
...
PETSC_EXTERN PetscBool      IGAElementNextPointStagger(IGAElement element,IGAElement element_stagger,IGAPoint point,IGAPoint point_stagger);
...
PETSC_EXTERN PetscErrorCode IGAPointExtremeCoord(IGAPoint point,PetscInt n,PetscBool max,const PetscScalar a[],PetscScalar A[]);
...
PETSC_EXTERN PetscErrorCode IGAComputeCoordExtrema(IGA iga,Vec U,
                                             PetscInt n,PetscScalar S[],
                                             IGAFormScalar Scalar,PetscBool max,void *ctx);
...
PETSC_EXTERN PetscErrorCode IGAComputeSystemSemiStagger(IGA iga,Mat matA,Vec vecB,Vec VecUStagger);
PETSC_EXTERN PetscErrorCode IGAComputeSystemStagger(IGA iga,IGA iga_stagger,Mat matA,Vec vecB,Vec VecUStagger);
