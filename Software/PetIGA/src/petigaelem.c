...
{
  PetscBool Elem1 = IGANextElement(iga,element);
  PetscBool Elem2 = IGANextElement(iga_stagger,element_stagger);
  if (Elem1 && Elem2){
      PetscFunctionReturn(PETSC_TRUE);
  }else{
    PetscFunctionReturn(PETSC_FALSE);
...
{
  PetscBool Point1 = IGAElementNextPoint(element,point);
  PetscBool Point2 = IGAElementNextPoint(element_stagger,point_stagger);
  if (Point1 && Point2){
      PetscFunctionReturn(PETSC_TRUE);
  }else{
    PetscFunctionReturn(PETSC_FALSE);
